                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span>
                                                    ...
                                                    <a
                                                        href="javascript:void(0)">{{ $product->category->name ?? 'Danh mục đang cập nhật' }}</a>
                                ...
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <div class="ltn__comment-area mb-30">
                                        <div class="ltn__comment-inner">
                                            @include('user.components.includes.review-list', [
                                                'product' => $product,
                                            ])
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="add-a-review">
                                                        ...
                                                        <div class="product-ratting">
                                                            <ul>
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    <li>
                                                                        <a href="javascript:void(0)" class="rating-start"
                                                                            data-value="{{ $i }}">
