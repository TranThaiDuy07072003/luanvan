...
<body
    ...
    <div style="max-width: 700px; margin: 0 auto; background: #fff; padding: 20px; border-radius: 8px;">
        ...
        <p
            ...
            {{ $order->payment->payment_method == 'vnpay' ? 'Thanh toán bằng VNPay' : 'Thanh toán khi nhận hàng' }}
        </p>
        <p style="font-size: 14px; color: #777;">Nếu là VNPay, thanh toán đã được xử lý trực tuyến. Nếu là thanh toán
            khi nhận hàng, khách hàng sẽ thanh toán khi sản phẩm được giao.</p>
