                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                ...
                                <form id="update-profile" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="phone">Số điên thoại <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                ...
                                <form id="change-password" data-parsley-validate class="form-horizontal form-label-left" style="display: none">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="confirm_password">Xác nhận mật khẩu mới <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
