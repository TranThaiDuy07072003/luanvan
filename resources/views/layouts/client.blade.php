...
<body>
    ...
    <div class="wrapper">
        @include('user.partials.header') <!-- Đường dẫn của header -->

            @hasSection('breadcrumb')
                @include('user.partials.breadcrumb') <!-- Đường dẫn của breadcrumb -->
            @endif
        ...
        @include('user.partials.footer') <!-- Đường dẫn của footer -->
